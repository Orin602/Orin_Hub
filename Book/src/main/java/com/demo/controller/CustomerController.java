...
public class CustomerController {
	...
	@PostMapping("/customer_notice_like")
	@ResponseBody
	public Map<String, Object> increaseLike(@RequestBody Map<String, Object> param, HttpSession session) {
	    ...
	    int notice_seq = Integer.parseInt(param.get("notice_seq").toString());

	    try {
	        noticeService.increaseLikeCount(notice_seq, loginUser.getId());
	...
	public String noticeDetailView(HttpSession session, Model model,
		...
		// 조회수 증가
	    noticeService.increaseViewCount(notice_seq, loginUser.getId());
